...
public class SerializationExample {
    public static void main(String[] args) {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(Objects.requireNonNull(ClassLoader.getSystemClassLoader().getResource("serialization_externalization/serialization")).getFile())) {
